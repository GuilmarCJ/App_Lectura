...
fun Nivel3Screen(
    ...
    val progresoAnterior by db.progresoDao().obtenerProgresoPorNivel(3).collectAsState(initial = null)
        ...
        Column(
            ...
            pregunta.opciones.forEachIndexed { index, opcion ->
                Card(
                    ...
                    Text(text = opcion, modifier = Modifier.padding(16.dp))
                }
            }
            ...
            Button(
                ...
                Text(if (preguntaActual == preguntasSeleccionadas.lastIndex) "Finalizar" else "Siguiente")
            }
        }
    }
